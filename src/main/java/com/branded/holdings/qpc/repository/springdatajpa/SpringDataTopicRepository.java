 ...
 */
package com.branded.holdings.qpc.repository.springdatajpa;
...
public interface SpringDataTopicRepository extends TopicRepository, Repository<Topic, Integer> {

    @Override
    @Query("SELECT etype FROM emotiontype etype ORDER BY etype.name")
